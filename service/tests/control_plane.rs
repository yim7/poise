...
use grid_platform_service::{
    ...
    protocol::{
        ...
        CommandType, HttpSuccessEnvelope, OpenOrder, OpenOrdersSource, RecentFill, RiskEvent,
        RiskLevel, RiskState, RuntimeSnapshot, ServerEnvelope, ServerEvent, SystemEvent,
    },
